...
def parse_args():
    ...
    parser.add_argument('--vector-file', nargs='?', default='/Users/aryatschand/Documents/GitHub/edge2vec/vector.txt', help='node vector')
    parser.add_argument('--pair-file', nargs='?', default='/Users/aryatschand/Documents/GitHub/edge2vec/data.txt', help='pair relation label')
